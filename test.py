...
def get_args():
    ...
    parser.add_argument('--in_chans', type=int and tuple, default=3, help='Channels of input images')
    parser.add_argument('--json_path', type=str, default=r".../test.json", help='.json path')
